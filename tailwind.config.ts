...
const proseBlack = ({ theme }) => ({
  ...
  // '--tw-prose-th-borders': theme('colors.black/20'),
  '--tw-prose-th-borders': 'rgb(0 0 0 / 20%)',
  '--tw-prose-td-borders': 'rgb(0 0 0 / 20%)',
  ...
  '--tw-prose-invert-hr': 'rgb(255 255 255 / 20%)',
  ...
  '--tw-prose-invert-th-borders': 'rgb(255 255 255 / 20%)',
  '--tw-prose-invert-td-borders': 'rgb(255 255 255 / 20%)',
});
